...
1. Create a build directory for FastScape and compile it with an added flag for creating a shared library: `cmake -DBUILD_FASTSCAPELIB_SHARED=ON /path/to/fastscape/build/dir` then `make` to compile.
