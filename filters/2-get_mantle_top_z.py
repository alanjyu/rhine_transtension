...
scalars = input_data.GetPointData().GetArray("mantle_z") # replace with the correct input array
...
output_data.GetPointData().SetActiveScalars("mantleTopZ")