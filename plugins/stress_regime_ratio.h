...
#ifndef _aspect_postprocess_visualization_stress_regime_ratio_h
#define _aspect_postprocess_visualization_stress_regime_ratio_h
...
//            jacobi(dealii::SymmetricTensor<2, dim, Number> A);
          ...
          public Interface<dim>
      {
        public:
          ...
          compute_sigmaH_regime_ratio(const SymmetricTensor<2,dim> compressive_stress,
